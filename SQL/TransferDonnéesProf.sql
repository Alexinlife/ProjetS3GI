...
--INSERT INTO public.tutorat_utilisateur (cip, tutorat_id) SELECT DISTINCT extern_presence.group_students.cip, public.tutorat.id FROM extern_presence.group_students,extern_presence.group_appointments , public.tutorat WHERE extern_presence.group_appointments.unit_id = extern_presence.group_students.unit_id AND extern_presence.group_appointments.grouping = extern_presence.group_students.grouping AND extern_presence.group_appointments.no = extern_presence.group_students.no AND extern_presence.group_appointments.activity_id = public.tutorat.numero;
INSERT INTO public.tutorat_utilisateur (cip, tutorat_id) VALUES ('doyf1501', 1), ('doyf1501', 2), ('doyf1501', 3), ('laja1501', 2), ('laja1501', 3), ('laja1501', 4), ('pelf1504', 3), ('pelf1504', 4), ('pelf1504', 5);